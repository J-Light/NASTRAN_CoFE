...
% Anthony Ricciardi
%
classdef cbar < structure & plot1D
    ...
    methods
        ...
        function obj = initialize(obj,data)
            ...
            obj.GA   = set_data('CBEAM','GA',data{4},'int',[]);
            obj.GB   = set_data('CBEAM','GB',data{5},'int',[]);
            obj.X2   = set_data('CBEAM','X2',data{7},'dec', nan);
            obj.X3   = set_data('CBEAM','X3',data{8},'dec', nan);
            
            if isnan(obj.X2) & isnan(obj.X3 )
                obj.X1 = nan;
                obj.G0   = set_data('CBEAM','GB',data{6},'int',[]);
            else
                obj.G0   = nan;
